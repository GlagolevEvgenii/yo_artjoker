...
module.exports = function() {
  ...
  var updateMessage = function(update) {
    ...
    var line2 =
      " Run " +
      chalk.red("npm update -g " + notifier.packageName) +
      " to update. ";
  ...
  var copyToClipboard = function(data) {
    ...
    switch (process.platform) {
      ...
      case "openbsd":
        ...
        break;
      default:
        throw "Tried to copy update command to your clipboard, but you are using unknown platform: " +
          process.platform;
    }
      ...
      this.prompt(
        [
          {
            ...
            choices: [
              {
                name:
                  "Yes (stops the generator and copies the update command to clipboard)",
                value: "yesandcopy"
              },
              {
        ...
        function(props) {
          ...
          if (this.updateNotify === "yesandcopy") {
            ...
            this.log(
              chalk.yellow("Update command was copied to your clipboard \n")
            );
            process.exit();
